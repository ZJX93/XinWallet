...
CREATE TABLE IF NOT EXISTS transactions (
  ...
  -- 多币种折算痕迹：外币消费折成账户币种入账时记录原币与汇率，
  -- 使「50 USD @6.71 → ¥335.59」可追溯、可回显、可审计（方案B：折合成主账户币种记账）
...
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS original_amount DECIMAL(15,2) DEFAULT NULL;
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS original_currency VARCHAR(3) DEFAULT NULL;
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS exchange_rate DECIMAL(18,6) DEFAULT NULL;
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS rate_date DATE DEFAULT NULL;
