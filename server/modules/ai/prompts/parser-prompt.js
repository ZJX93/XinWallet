/* ============================================
   ...
   📌 版本收敛（DEFAULT_PROMPT_VERSION = 'v3'）：
      当前仅保留 v3（能力全集）= v2 全部能力 + Few-shot 先例；
      v1/v2 历史版本已移除，不再对外提供选择，也不作为回退开关。
   ============================================ */
 ...
 *    Few-shot 未启用时 v3 退化为 v2 本体（formatFewShot 返回空串），无需特判。
 */
 ...
 * @param {string} [params.version]     指定版本（默认取环境变量 / v3）
...
/* ════════════════════════════════════════════════════════════
   v3 本体（曾命名 v2）—— 让模型承担语义理解（本地规则算力不足时主力）
   ════════════════════════════════════════════════════════════ */
